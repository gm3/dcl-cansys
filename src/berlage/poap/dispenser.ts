...
/*
  MODIFIED to have a POAP coin instead of full Dispenser model 
*/
...
export function createDispenser(
  ...
  button.addComponent(new GLTFShape('models/socials/poap-berlage.gltf'))
